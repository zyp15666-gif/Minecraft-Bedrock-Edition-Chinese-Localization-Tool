...
'''
        ...
        print(f"✅ 已生成修复脚本: fix_translation_consistency.py")
        print(f"   包含 {min(50, len(suggestions))} 个修复规则")
        print(f"\n💡 使用方法:")
        print(f"   1. 审查修复规则，确保翻译准确")
        print(f"   2. 运行: python fix_translation_consistency.py")
        print(f"   3. 检查生成的 zh_cn_fixed.lang 文件")
